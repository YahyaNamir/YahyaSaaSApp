...
export const metadata: Metadata = {
  ...
  description: "This is Settings page for YahyaAdmin Next.js",
  // other metadata
};
                ...
                <form action="#">
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          name="fullName"
                          id="fullName"
                          placeholder="Yahya Namir"
                          defaultValue="Yahya Namir"
                        />
                      </div>
                    </div>
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        ...
                        name="phoneNumber"
                        id="phoneNumber"
                        placeholder="+212 688 609204"
                        defaultValue="+212 688 609204"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="emailAddress"
                        id="emailAddress"
                        placeholder="yahyanamir5@gmail.com"
                        defaultValue="yahyanamir5@gmail.com"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-5.5">
                    ...
                    <input
                      ...
                      name="Username"
                      id="Username"
                      placeholder="yahyanamir"
                      defaultValue="yahyanamir"
                    />
                  </div>
